...
namespace MlHost.Test.Controller
{
    ...
    public class QuestionControllerTests
    {
        ...
        public async Task GivenTestModel_WhenUsed_ShouldResponed()
        {
            ...
            var response = await host.Client.PostAsync("api/submit", new StringContent(content, Encoding.UTF8, "application/json"));
            ...
            predictResponse.Request.Should().Be(question.Sentence);
