...
namespace Toolbox.Tools.Local
{
    ...
    public class LocalProcess : IDisposable
    {
        ...
        public Task<LocalProcess> Run(CancellationToken cancellationToken)
        {
            ...
            _tokenRegistration = _tokenRegistration ?? cancellationToken.Register(() =>
            {
        ...
        private void OnProcessExit(object? sender, EventArgs args)
        {
            ...
            if (_processCompletedTcs == null) throw new ArgumentNullException(nameof(_processCompletedTcs));
